...
def test_little_load_powerset_no_wind_efficiency():
    """
    Tests the calculations when no wind efficiency is given and low load, so in this case the
    plants entering the grid will be only the ones with the pmin low enough to cover it.
    """
